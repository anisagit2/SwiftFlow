...
import { renderDocumentReadinessPage } from "./pages/documentReadiness.js";
...
export const renderPage = (state) => {
    if (state.activeTab === "notifications") return renderNotificationsPage(state);
    ...
    if (state.activeTab === "document-readiness") return renderDocumentReadinessPage(state);
